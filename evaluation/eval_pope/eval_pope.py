...
parser.add_argument("--gt_files", type=str, default="/mnt-nfsdata/gongxuan/data-1/gx_damro/data/pope/coco/coco_pope_random.json")
parser.add_argument("--gen_files", type=str, default="/mnt-nfsdata/gongxuan/data-1/gx_damro/output/test.jsonl")
...
for index, line in enumerate(gt_files):
    ...
    gen_answer = gen_files[index]["output"]
